...
defineOptions({ name: 'InputFormBruteV2' })
...
<style scoped>
.input-form .row { display:flex; align-items:center; gap:.5rem; margin-bottom:.75rem; }
.input-form input { flex:1; padding:.5rem .75rem; border:1px solid var(--color-border); border-radius:.5rem; }
